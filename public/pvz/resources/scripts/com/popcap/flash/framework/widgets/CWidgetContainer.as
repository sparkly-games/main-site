package com.popcap.flash.framework.widgets
{
   ...
   public class CWidgetContainer
   {
      ...
      public function sysColorChangesAll() : void
      {
         ...
         var _loc1_:int = this.widgets.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function putInfront(param1:CWidget, param2:CWidget) : void
      {
         ...
         var _loc4_:int = this.widgets.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = this.widgets[_loc5_];
            if(_loc6_ == param2)
            {
      ...
      public function updateAll(param1:CModalFlags) : void
      {
         ...
         var _loc2_:int = this.widgets.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.widgets[_loc3_];
            if(_loc4_ == this.widgetManager.baseModalWidget)
            {
               param1.isOver = true;
            }
      ...
      public function getWidgetAtHelper(param1:Number, param2:Number, param3:Number, param4:Point) : CWidget
      {
         ...
         var _loc5_:int = this.widgets.length;
         var _loc6_:int = _loc5_ - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.widgets[_loc6_];
            if(_loc7_.visible)
            {
               _loc8_ = _loc7_.getWidgetAtHelper(param1,param2,param3,param4);
               if(_loc8_ != null)
               {
                  return _loc8_;
               }
      ...
      public function isBelowHelper(param1:CWidget, param2:CWidget) : Boolean
      {
         ...
         var _loc3_:int = this.widgets.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc5_ = this.widgets[_loc4_];
            ...
            _loc6_ = _loc5_.isBelowHelper(param1,param2);
            if(_loc6_)
            {
               return true;
            }
      ...
      public function drawAll(param1:CModalFlags, param2:Graphics2D) : void
      {
         ...
         if(this.clip && param1.getFlags() & CWidgetManager.WIDGETFLAGS_CLIP)
         {
         }
         if(this.widgets.length == 0)
         {
      ...
      public function markDirtyFull(param1:CWidgetContainer = null) : void
      {
         ...
         _loc3_ = _loc2_;
         var _loc6_:int = this.widgets.length;
         while(_loc3_ < _loc6_)
         {
            _loc5_ = this.widgets[_loc3_];
            if(_loc5_.visible && _loc5_.intersects(param1))
            {
               _loc5_.markDirty();
            }
            _loc3_++;
