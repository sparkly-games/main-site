package com.popcap.flash.framework.resources.fonts
{
   ...
   public class FontInst
   {
      ...
      public function draw(param1:Graphics2D, param2:Number, param3:Number, param4:String, param5:Rectangle) : void
      {
         ...
         param1.identity();
         var _loc9_:int = this.mData.layerList.length;
         var _loc10_:int = 0;
         while(_loc10_ < _loc9_)
         {
            ...
            while(_loc14_ < _loc13_)
            {
               ...
               if(_loc16_.mImage != null)
               {
                  ...
                  _loc24_ = _loc16_.mImage;
                  _loc24_.setColor(this.mColorTransform.alphaMultiplier * _loc23_.alpha,this.mColorTransform.redMultiplier * _loc23_.red,this.mColorTransform.greenMultiplier * _loc23_.green,this.mColorTransform.blueMultiplier * _loc23_.blue);
               ...
               _loc18_ = _loc18_ + (_loc20_ + _loc19_);
               if(_loc18_ > _loc17_)
               {
                  _loc17_ = _loc18_;
               }
