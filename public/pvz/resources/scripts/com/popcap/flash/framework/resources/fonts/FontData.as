package com.popcap.flash.framework.resources.fonts
{
   ...
   public class FontData
   {
      ...
      public function charWidthKern(param1:Number, param2:Number) : Number
      {
         ...
         var _loc3_:Number = 0;
         var _loc4_:int = this.layerList.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = this.layerList[_loc5_].getCharData(param1);
            _loc3_ = _loc3_ < _loc6_.mWidth?Number(_loc6_.mWidth):Number(_loc3_);
            _loc5_++;
         }
         return _loc3_;
      }
      ...
      public function getAscent() : Number
      {
         ...
         {
            _loc1_ = _loc2_.mAscent > _loc1_?Number(_loc2_.mAscent):Number(_loc1_);
         }
         return _loc1_;
      }
      ...
      public function stringImageWidth(param1:String) : Number
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            {
               _loc11_ = this.layerList[_loc10_];
               _loc12_ = _loc11_.getCharData(_loc7_);
               _loc13_ = _loc4_;
               _loc14_ = 0;
               ...
               _loc13_ = _loc13_ + (_loc15_ + _loc14_);
               if(_loc13_ > _loc8_)
               {
                  _loc8_ = _loc13_;
               }
      ...
      public function getHeight() : Number
      {
         ...
         for each(_loc2_ in this.layerList)
         {
            _loc1_ = _loc2_.height > _loc1_?Number(_loc2_.height):Number(_loc1_);
         }
         return _loc1_;
      }
      ...
      public function stringWidth(param1:String) : Number
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc2_ = _loc2_ + this.charWidthKern(_loc6_,_loc3_);
            _loc3_ = _loc6_;
            _loc5_++;
         }
         return _loc2_;
      ...
      public function getLineSpacing() : Number
      {
         ...
         for each(_loc2_ in this.layerList)
         {
            _loc1_ = _loc2_.mSpacing > _loc1_?Number(_loc2_.mSpacing):Number(_loc1_);
         }
         return _loc1_;
      }
   }
