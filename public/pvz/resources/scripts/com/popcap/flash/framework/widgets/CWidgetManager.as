package com.popcap.flash.framework.widgets
{
   ...
   public class CWidgetManager extends CWidgetContainer
   {
      ...
      {
         var _loc4_:CWidget = this.getAnyWidgetAt(param1,param2,param3);
         if(_loc4_ != null && _loc4_.disabled)
         {
            _loc4_ = null;
         }
         return _loc4_;
      ...
      public function doKeyUp(param1:uint) : void
      {
         ...
         if(param1 == Keyboard.TAB && this.keyDown[Keyboard.CONTROL])
         {
            return;
         }
      ...
      public function flushDeferredOverlayWidgets(param1:Graphics2D, param2:Number) : void
      {
         ...
         do
         {
            ...
            while(_loc5_ < _loc4_)
            {
               _loc6_ = this.deferredOverlayWidgets[_loc5_];
               _loc7_ = _loc6_.widget;
               if(_loc6_.widget != null)
               {
                  _loc8_ = _loc6_.priority;
                  if(_loc8_ == this.minDeferredOverlayPriority)
                  {
                     param1.pushState();
      ...
      public function drawScreen(param1:Graphics2D) : void
      {
         ...
         var _loc6_:Number = 0;
         var _loc7_:CWidget = null;
         var _loc8_:int = widgets.length;
         _loc6_ = 0;
         while(_loc6_ < _loc8_)
         {
            _loc7_ = widgets[_loc6_];
            if(_loc7_.dirty)
            {
               _loc3_++;
            }
         ...
         if(_loc3_ > 0)
         {
            ...
            {
               _loc7_ = widgets[_loc6_];
               if(_loc7_ == widgetManager.baseModalWidget)
               {
      ...
      public function setMousePosition(param1:Number, param2:Number) : void
      {
         ...
         var _loc6_:CWidget = this.getWidgetAt(param1,param2,_loc5_);
         if(_loc6_ != this.overWidget)
         {
