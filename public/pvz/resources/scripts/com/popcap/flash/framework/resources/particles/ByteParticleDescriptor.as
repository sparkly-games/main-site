package com.popcap.flash.framework.resources.particles
{
   ...
   public class ByteParticleDescriptor implements ParticleDescriptor
   {
      ...
      public function createData(param1:AppBase) : ParticleDefinition
      {
         ...
         var _loc2_:ParticleDefinition = new ParticleDefinition();
         this.mBytes.position = 0;
         var _loc3_:int = this.mBytes.readInt();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc5_ = new ParticleEmitterDefinition();
            _loc5_.mName = this.mBytes.readUTF();
            ...
            while(_loc6_ < _loc7_)
            {
               _loc9_ = new ParticleField();
               _loc9_.mFieldType = ParticleFieldType.fromUInt(this.mBytes.readUnsignedInt());
            ...
            while(_loc6_ < _loc8_)
            {
               _loc10_ = new ParticleField();
               _loc10_.mFieldType = ParticleFieldType.fromUInt(this.mBytes.readUnsignedInt());
      ...
      private function readParam(param1:ByteArray, param2:FloatParameterTrack) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc5_ = new FloatParameterTrackNode();
            _loc5_.mCurveType = CurveType.fromUInt(param1.readUnsignedInt());
