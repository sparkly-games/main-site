      ...
      public function createFontData(param1:AppBase) : FontData
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               _loc12_ = this.mBytes.readInt();
               _loc10_ = _loc12_;
               _loc6_.mCharData[_loc12_] = _loc11_;
               ...
               _loc13_ = _loc11_.mImageRect;
               if(!(_loc13_.width == 0 || _loc13_.height == 0))
               {
                  _loc14_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                  _loc14_.copyPixels(_loc8_,_loc13_,_loc2_);
