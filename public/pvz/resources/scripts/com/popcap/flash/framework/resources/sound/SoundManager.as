package com.popcap.flash.framework.resources.sound
{
   ...
   public class SoundManager
   {
      ...
      private function getData(param1:String) : SoundData
      {
         ...
         var _loc4_:SoundData = _loc2_ as SoundData;
         if(_loc4_ == null)
         {
      ...
      public function playSound(param1:String, param2:Number = 1) : SoundInst
      {
         ...
         var _loc4_:SoundInst = this.getSoundInst(_loc3_,param2);
         _loc4_.play(this.mGlobalVolume);
         return _loc4_;
      }
      ...
      public function resumeAll() : void
      {
         ...
         var _loc1_:int = this.mInstPool.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function getSoundInst(param1:SoundData, param2:int) : SoundInst
      {
         ...
         var _loc4_:int = this.mInstPool.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = this.mInstPool[_loc5_];
            if(_loc6_.isDead())
            {
               _loc3_ = _loc6_;
               break;
         ...
         param1.mRefCount = param1.mRefCount + 1;
         return _loc3_;
      }
      ...
      public function setVolume(param1:Number) : void
      {
         ...
         var _loc2_:int = this.mInstPool.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.mInstPool[_loc3_];
            _loc4_.setVolume(this.mGlobalVolume);
            _loc3_++;
         }
      }
