package com.popcap.flash.framework.states
{
   ...
   public class CStateManager implements IStateManager
   {
      ...
      public function changeState(param1:String) : void
      {
         ...
         var _loc3_:int = this.stack.length;
         var _loc4_:int = _loc3_ - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.stack[_loc4_] as IState;
            _loc5_.onExit();
            _loc4_--;
         }
         this.stack = new Array();
      ...
      public function draw(param1:Graphics2D) : void
      {
         ...
         var _loc2_:int = this.stack.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.stack[_loc3_] as IState;
            _loc4_.draw(param1);
            _loc3_++;
         }
      }
      ...
      {
         var _loc1_:int = this.stack.length - 1;
         if(_loc1_ < 0)
         {
            return;
         }
